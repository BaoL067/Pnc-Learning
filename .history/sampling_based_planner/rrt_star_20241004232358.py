        ...
        def planning(self):
            ...
            for i in range(self.max_iter):
                ...
                if d >= self.path_resolution:
                    extend_node = self.Node(nearest_node.x + self.extend_dist * dx / d, nearest_node.y + self.extend_dist * dy / d)
                    extend_node.parent = nearest_node
                    extend_node.cost = nearest_node.cost + self.extend_dist
                else:
                    continue
                ...
                if self.check_collision_with_obs_map(new_node, self.obstacle_map):
                    ...
                    # TODO: 5. rewe the tree and draw current node and the edge between it and its parent node
