...
class RRTStar:
    ...
    class Node:
        ...
        def draw_start_and_goal(self):
            plt.plot(self.start.x, self.start.y, marker='*', color='darkviole', markersize=8, zorder=100000)
            plt.plot(self.end.x, self.start.y, marker='*', color='darkviole', markersize=8, zorder=100000)         