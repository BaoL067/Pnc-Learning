...
config_path = str(pathlib.Path.cwd()) + r"\sampling_based_planner\dwa\config\config.yaml"
"D:\Github_repo\Pnc-Learning\sampling_based_planner\dwa\config\config.yml"
class State:
