    ...
    def planning(self):
        ...
        for i in range(self.max_iter):
            ...
            if self.check_collision_with_obs_map(new_node, self.obstacle_map):
                ...
                collision_free_nodes = [node for node in near_nodes if self.check_collision_with_obs_map(node, self.obstacle_map)]
                ...
                #     self.rewire(new_node, optimal_node)
                #     if not self.check_collision_with_obs_map(new_node, self.obstacle_map):
                #         new_node.reset()
                #         continue
                #     else:
                #         self.draw_node_and_edge(new_node)
