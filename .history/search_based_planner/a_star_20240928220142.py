...
class AStarPlanner:
    def __init__(self, binary_img, resolution, min_safety_dist):
        """
        ...
        self.get_obstacle_map(binary_img)
        # create motion model
    ...
    def get_obstacle_map(self, binary_img):
        self.x_width = binary_img.shape[1]
        self.y_width = binary_img.shape[0]
        print("Map x: ",  self.x_width)
        print("Map y: ",  self.y_width)
        self.obstacle_map = binary_img == 0
        print("Obstacle map shape: ", self.obstacle_map.shape)
...
def main():
    ...
    a_star = AStarPlanner(binary_img, grid_res, min_safety_dist)
